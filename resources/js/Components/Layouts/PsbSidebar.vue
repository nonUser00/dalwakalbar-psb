...
const menuGroups = [
    ...
    },
    {
        ...
        items: [
            { title: 'Tagihan Biaya', url: '/psb/keuangan/tagihan' },
            { title: 'Virtual Account', url: '/psb/keuangan/va' },
            { title: 'Riwayat Tagihan', url: '/psb/keuangan/riwayat' },
        ],
    },
    {
        heading: 'SELEKSI & KELULUSAN',
        title: 'Ujian & Seleksi',
        icon: 'M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z',
        items: [
            { title: 'Jadwal Interview & Tes', url: '/psb/ujian/jadwal' },
            { title: 'Pengumuman Kelulusan', url: '/psb/ujian/pengumuman' },
        ],
    },
    {
        heading: 'KEBERANGKATAN & ASRAMA',
        title: 'Keberangkatan',
        icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',
        items: [
            {
                title: 'Pilihan Rombongan',
                url: '/psb/keberangkatan',
                disabled: true,
                badgeText: 'Soon',
            },
            {
                title: 'Titik Kumpul & Manifes',
                url: '/psb/keberangkatan',
                disabled: true,
                badgeText: 'Soon',
            },
            {
                title: 'Kedatangan & Asrama',
                url: '/psb/keberangkatan',
                disabled: true,
                badgeText: 'Soon',
            },
...
const isItemActive = (itemUrl: string) => {
    ...
    return pagePath === itemUrl || pagePath.startsWith(itemUrl + '/');
};
            ...
            <template v-for="(group, idx) in menuGroups" :key="idx">
                ...
                >
                    <Link
                        ...
                        :class="[
                            ...
                            'group/item flex items-center justify-between rounded-xl px-3 py-2.5 text-[13.5px] transition-all duration-200',
                            isDesktopCollapsed
                    ...
                    >
                        <div class="flex items-center min-w-0">
                            <div class="relative">
                                ...
                                <span
                                    v-if="isDesktopCollapsed && getSidebarBadge(group.url || '')"
                        ...
                        <span
                            v-if="getSidebarBadge(group.url || '')"
                ...
                >
                    ...
                    <div
                        ...
                        @mouseleave="handleMouseLeaveGroup"
                        :class="[
                            idx >= menuGroups.length - 2 ? 'bottom-0' : 'top-0',
                    ...
                    >
                        ...
                        >
                            <div class="flex min-w-0 items-center gap-2.5">
                                <div
                                    class="flex h-6.5 w-6.5 items-center justify-center rounded-lg bg-primary/10 text-primary dark:bg-primary/25 dark:text-blue-300"
                                >
                                    <svg
                                        class="h-3.5 w-3.5"
                                        fill="none"

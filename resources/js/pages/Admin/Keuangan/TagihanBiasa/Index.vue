...
const columns = [
    { key: 'name', label: 'NAMA KATEGORI TAGIHAN' },
...
<template>
    <div class="relative min-h-screen w-full">
        <Head title="Tagihan Biasa & Lainnya" />
            ...
            >
                ...
                >
                    <div class="flex items-start gap-4">
                        <div
                            class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-indigo-500/10 p-2 text-indigo-600 shadow-inner dark:bg-indigo-950/60 dark:text-indigo-400"
                        >
                            <svg
                                class="h-8 w-8"
                                fill="none"
                        ...
                        <div>
                            <div class="flex flex-wrap items-center gap-2.5">
                                ...
                                >
                                    Tagihan Biasa & Lainnya
                                </h1>
                                <span
                                    class="inline-flex items-center rounded-full bg-indigo-50 px-3 py-1 text-xs font-black tracking-wide text-indigo-700 uppercase dark:bg-indigo-950/60 dark:text-indigo-400"
                                >
                                    Global / Rutin
                                </span>
                            </div>
                            ...
                            >
                                Atur tarif dan komponen biaya tagihan biasa
                                seperti SPP/Syahriah bulanan, modul kitab,
                                seragam, dan iuran kegiatan.
                            </p>
                        </div>
                    </div>
            ...
            >
                <template #cell-name="{ row }">
                    <div class="flex items-center gap-3.5 py-1">
                        <div
                            class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-indigo-100 bg-indigo-50 text-indigo-600 shadow-xs dark:border-indigo-900/50 dark:bg-indigo-950/60 dark:text-indigo-400"
                        >
                            <svg
                                class="h-5 w-5"
                                fill="none"
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="mt-0.5 flex items-center gap-2">
                                <span
                                    class="inline-flex items-center rounded-md bg-indigo-50 px-2 py-0.5 text-[11px] font-bold text-indigo-700 dark:bg-indigo-950/60 dark:text-indigo-400"
                                >
                    ...
                    >
                        ...
                        >
                            <div class="flex items-center gap-3">
                                <div
                                    class="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-600 text-white shadow-sm shadow-indigo-200 dark:bg-indigo-600 dark:shadow-none"
                                >
                                    <svg
                                        class="h-5 w-5"
                                        fill="none"
                                ...
                                <div>
                                    ...
                                    >
                                        Rincian Biaya:
                                        <span
                                            class="rounded-full bg-indigo-100 px-2.5 py-0.5 text-xs font-bold text-indigo-800 dark:bg-indigo-950/60 dark:text-indigo-400"
                                        >
                                            {{ row.name }}
                                        </span>
                                    </h4>
                                    ...
                                    >
                                        Daftar rincian komponen biaya rutin atau
                                        tagihan berkala.
                                    </p>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            >
                                Belum ada rincian biaya untuk kategori tagihan
                                ini.
                            </p>
                            <p
        ...
        <Modal
            ...
            :description="
                isEditingKategori
                    ? 'Perbarui nama kategori tagihan biasa'
                    : 'Buat kategori tagihan biasa baru (berlaku global)'
            "
        >
            <template #icon>
                <div
            ...
            >
                <TextInput
                    ...
                    placeholder="Contoh: Biaya SPP / Syahriah Bulanan, Biaya Kitab & Modul"
                    required
                />
            </form>
        ...
        <Modal
            ...
            :description="
                activeKategoriForItem
                    ...
                    : 'Rincian komponen biaya tagihan'
            "
        >
            <template #icon>
                <div
            ...
            >
                <TextInput
                    ...
                    placeholder="Contoh: Syahriah Bulanan, Uang Kitab Semester 1"
                    required
                />

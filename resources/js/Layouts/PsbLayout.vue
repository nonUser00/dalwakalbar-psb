...
import PsbHeader from '@/Components/Layouts/PsbHeader.vue';
import PsbSidebar from '@/Components/Layouts/PsbSidebar.vue';
...
onMounted(() => {
    if (typeof window !== 'undefined') {
        const stored = localStorage.getItem('psb_sidebar_collapsed');
        ...
        <div class="flex flex-1 flex-col overflow-hidden">
            ...
            >
                ...
                >
                    ...
                    <!-- Footer -->
                    <footer
                        class="mt-12 border-t border-slate-200 pt-6 pb-2 text-center text-sm font-medium text-slate-500 transition-colors dark:border-slate-800/80 dark:text-slate-400"
                    >

...
const page = usePage();
const user = computed(
    () => ((page.props as any).pendaftar || (page.props.auth as any)?.user) as any,
);
</script>
...
<template>
    ...
    >
        ...
        <div class="flex items-center gap-1.5 sm:gap-2.5">
            ...
            <!-- Profile Dropdown matching AdminHeader.vue -->
            <div class="relative">
                <button
                ...
                >
                    ...
                    >
                        ...
                        <span
                            ...
                            >{{ (user?.nama || user?.name || 'S')?.charAt(0) }}</span
                        >
                    </div>
                    <svg
                ...
                <!-- Dropdown Panel matching AdminHeader.vue (2 Menu Items) -->
                <transition
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {{ user?.nama || user?.name || 'Calon Santri' }}
                            </p>
                            <p
                                class="mt-0.5 truncate font-mono text-xs font-medium text-primary dark:text-blue-400"
                            >
                                {{ user?.nomor_pendaftaran || user?.email || '-' }}
                            </p>
                        </div>

...
class DraftPendaftarExport extends DefaultValueBinder implements FromCollection, ShouldAutoSize, WithCustomValueBinder, WithEvents, WithHeadings, WithMapping, WithStyles
{
    protected $ids;
    ...
    public function map($p): array
    {
        ...
        $statusStr = $p->status instanceof PendaftarStatus ? $p->status->value : (string) ($p->status ?? 'DRAFT');
        ...
        $created = $p->created_at ? $p->created_at->format('d/m/Y H:i') : '-';
